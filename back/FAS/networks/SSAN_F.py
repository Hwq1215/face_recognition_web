...
class Discriminator(nn.Module):
    def __init__(self, max_iter, class_num=3):
...
class SSAN_F(nn.Module):
    def __init__(self, ada_num=2, max_iter=4000):
        super(SSAN_F, self).__init__()
        ...
        self.dis_1 = Discriminator(max_iter, 11)
        # self.dis_2 = Discriminator(max_iter, 5)
        # self.dis_3 = Discriminator(max_iter, 3)
    ...
    def forward(self, input1, input2):
        ...
        dis_invariant_st = self.dis_1(domain_invariant)
        # dis_invariant_ic = self.dis_2(domain_invariant)
        # dis_invariant_ec = self.dis_3(domain_invariant)

        return cls_x1_x1, fea_x1_x1, fea_x1_x2, dis_invariant_st