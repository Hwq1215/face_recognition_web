...
class ClelebA_Spoofing_train_dataset(Dataset):
    def __init__(self, root_dir, transform=None, scale_up=1.5, scale_down=1.0, img_size=256, map_size=32,
                 UUID=-1):
        self.frame = pd.read_csv(os.path.join(root_dir, 'metas/intra_test/train_label.txt'), sep=' ', header=None)
        ...
        # self.UUID = UUID
        self.info_dict = json.load(open(os.path.join(root_dir, 'metas/intra_test/train_label.json'), 'r'))
