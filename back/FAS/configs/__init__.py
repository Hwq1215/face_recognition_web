...
def parse_args():
    ...
    # build dirs
    parser.add_argument('--data_dir', type=str, default="/root/autodl-tmp/CelebA_Spoof_zip2/CelebA_Spoof", help='YOUR_Data_Dir')
    parser.add_argument('--result_path', type=str, default='/root/Project/FAS/results', help='root result directory')
    parser.add_argument('--result_name', type=str, default='demo', help='result directory')
    # training settings
    parser.add_argument('--model_type', type=str, default="SSAN-R", help='model_type')
