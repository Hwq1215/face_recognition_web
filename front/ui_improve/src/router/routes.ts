...
const compareFace = () => import('../myViews/compareFace.vue')
const findFace = () => import('../myViews/findFace.vue')
const landmarks = () => import('../myViews/landmarks.vue')
const videoShow = () => import('../myViews/videoShow.vue')
