    ...
    <div class="flex flex-col mx-auto items-stretch h-full">
      ...
      <div class="h-19.5 flex items-center relative">
        <router-link
          ...
          :to="{ name: 'Dashboard' }"
        >
          <img src="@/assets/images/icon.png" class="max-h-8 max-w-full align-middle" alt="..." />
        </router-link>
        <div class="ml-auto">
            ...
            <template v-for="(item, index) in menuItems" :key="index">
              ...
              >
                <template #title>
                  ...
                  />
                  <span
                    class="inline-flex pl-1.5 items-center w-full text-lg my-0.5 font-normal transition-colors duration-150 hover:text-gray-500/100 focus:text-gray-800"
                  >
                    <div>
                      <em class="h-6 w-7 block">
                        <component
                          :is="item.icon"
                          :class="` w-6 mx-auto ${item.color}`"
                          aria-hidden="true"
                        />
                      </em>
                    </div>
                    <span
                      class="transition-opacity duration-300 opacity-1 ml-3 text-lg font-normal"
                      :class="{ 'opacity-0': !isSBOpen && !isSBPin }"
                      >{{ item.title }}</span
                    >
                  </span>
                ...
                <el-menu-item-group class="flex flex-col">
                  ...
                  >
                    ...
                    />
                    <router-link
                      class="inline-flex ml-2 items-center w-full h-full text-lg my-0.5 font-normal transition-all duration-200 hover:text-gray-500/100 focus:text-gray-800"
                      :class="{
                      ...
                      <div>
                        <em class="h-6 w-7 block">
                          <component
                            ...
                            :class="` w-6 mx-auto ${subItem.meta.color}`"
                            aria-hidden="true"
                          />
                        </em>
                      </div>
              ...
              >
                <template #title>
                  ...
                  />
                  <router-link
                    class="inline-flex pl-1.5 items-center w-full h-full text-lg my-0.5 font-normal transition-colors duration-150 hover:text-gray-300/100 focus:text-gray-800"
