            ...
            <div class="flex flex-nowrap mb-0 pl-0 justify-end gap-x-3">
              <div>
                <el-button
                  ...
                  @click="changeDataChart([0, 120, 102, 107, 115, 163, 203, 301])"
                >
                  <span class="hidden md:block font-medium text-sm px-2">月</span>
              ...
              <div>
                ...
                >
                  <span class="hidden md:block text-indigo-410 font-medium text-sm px-2">周</span>
...
export default defineComponent({
  ...
  setup() {
    const data = ref([0, 120, 102, 107, 115, 163, 203, 301])
